...
describe('StatusCommand', () => {
  ...
  it('should reply with strategy status', async () => {
    ...
    jest.spyOn(marketData, 'getDailyCandles').mockResolvedValue(new Array(30).fill({ high: 100, low: 90, close: 95 }));
    ...
    expect(mockCtx.replyWithMarkdown).toHaveBeenCalledWith(expect.stringContaining('*Nifty 50 Indicator:*'));
  });
